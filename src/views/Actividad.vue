...
export default {
  ...
  data: () => ({
    cuestionario: {
      ...
      titulo: 'Cuestionario',
      introduccion:
        '<b> Objetivo:</b> comprender los fundamentos prácticos relacionados con el ordenamiento territorial y derechos campesinos, mecanismos de participación ciudadana, dinámicas de la población campesina en el territorio, riesgos y amenazas en el ordenamiento territorial y técnicas de diagnóstico participativo.',
